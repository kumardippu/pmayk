...
.Lgnmain{width:50%; min-height:500px; position:absolute; left:50%; top:50%; margin-left:-25%; margin-top:-15%;}
...
.login_button{ width:8%; padding:1.1em 1.5em; border:none; line-height:1em; color:#fff; text-align:center; cursor:pointer; background:#f06d27; position:absolute; right:0; top:10px; border-radius:0px 5px 5px 0px; /*z-index:-9;*/}
